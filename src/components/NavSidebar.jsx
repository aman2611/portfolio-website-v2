  ...
  return (
    <div className="fixed right-[-70px] top-0 h-full flex flex-col justify-between items-start ml-4 text-white dark:text-black">
      ...
      <div className="flex justify-center items-center w-full mb-4">
        <p className="relative rotate-90 right-[18px] bottom-[120px] after:content-[''] after:block after:h-[2px] after:bg-gray-300 after:absolute after:top-1/2 after:left-full after:ml-2 after:w-40 hover:text-primary hover:after:bg-primary hover:translate-y-[-20px] transition-transform duration-300">
