    ...
    <html lang="en">
      <body className={poppins.className}>
        <Providers>
          ...
          <div className="grid  grid-col-1 md:grid-cols-12 gap-4 ml-10 bg-white text-black dark:bg-black dark:text-slate-400 ">
            ...
            <div className="flex col-span-7 ml-10">
              ...
              {showNavSidebar && (
                <div className="col-span-1 hidden sm:block md:block"> 
                  <NavSidebar />
                </div>
              )}
            </div>
